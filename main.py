...
# # async def create_user(user_data: UserData, background_tasks: BackgroundTasks):
# #     query = "INSERT INTO user_data (name) VALUES (:name)"
# #     values = {"name": user_data.name}

# #     try:
# #         await connect_to_database()
# #         await database.execute(query, values)
# #         background_tasks.add_task(background_task, user_data.name)
...
# # # Background task to perform on user creation
# # def background_task(name: str):
# #     print(f"User '{name}' added. Additional background task could be performed here.")
...
# # API to delete an entry from a table based on name and age
